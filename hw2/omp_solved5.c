...
#pragma omp parallel shared(a, b, nthreads, locka, lockb) private(tid)
  ...
  #pragma omp sections nowait
    {
    #pragma omp section
    // BUG: the first thread acquires locka and attempts to get lockb before releasing locka
    // similarly, the second thread acquires lockb and attempts to get locka before releasing lockb
    // which causes deadlock
    // the correct solution should have pair of set-unset
      {
